...
public class WebLogicClientApp {
    ...
    private static final String UT_JNDI     = "weblogic.transaction.UserTransaction";
    ...
    public static void main(String[] args) throws NamingException, NotSupportedException, Exception {
        ...
        Object dataSource = webLogicClientApp.fetchDataSource(ctx);
        ...
        try {
            ...
            if(data != null) {
                ...
                webLogicClientApp.insertIntoDB(ctx, dataSource, transaction);
    ...
    private Object fetchDataSource(Context ctx) throws NamingException {
        return ctx.lookup(DS_JNDI);
    }

    private Connection getConnection(Context ctx, Object obj) throws Exception {
        java.lang.reflect.Method m = obj.getClass().getMethod("getConnection");
    ...
    private void insertIntoDB(Context ctx, Object dataSource, Transaction transaction) throws Exception {
        try (Connection conn = getConnection(ctx, dataSource);
